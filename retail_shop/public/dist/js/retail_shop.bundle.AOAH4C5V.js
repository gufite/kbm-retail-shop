(() => {
  // ../retail_shop/retail_shop/public/js/retail_shop.bundle.js
  ...
  retail_shop.primary_shortcuts = /* @__PURE__ */ new Set([
    "Point of Sale",
    "Counter Sales",
    "Sales Invoice",
    "Purchase Receipt",
  ...
  retail_shop.get_user_roles = function() {
    var _a2, _b2;
    return ((_b2 = (_a2 = frappe.boot) == null ? void 0 : _a2.user) == null ? void 0 : _b2.roles) || [];
  };
  ...
  retail_shop.is_retail_workspace = function(page) {
    const workspace_name = (page == null ? void 0 : page.name) || (page == null ? void 0 : page.title) || page || "";
    return retail_shop.get_visible_workspaces().some(
      (visible_workspace) => {
        var _a2, _b2;
        return ((_a2 = frappe.router) == null ? void 0 : _a2.slug(workspace_name)) === ((_b2 = frappe.router) == null ? void 0 : _b2.slug(visible_workspace));
      }
    );
  };
  ...
  retail_shop.filter_boot_workspaces = function(pages) {
    return retail_shop.filter_workspace_pages(pages).filter((page) => ((page == null ? void 0 : page.name) || (page == null ? void 0 : page.title)) !== "Home");
  };
  retail_shop.is_visible_workspace_slug = function(slug) {
    return retail_shop.get_visible_workspaces().some(
      (workspace) => {
        var _a2;
        return ((_a2 = frappe.router) == null ? void 0 : _a2.slug(workspace)) === slug;
      }
    );
  };
  retail_shop.clear_stale_workspace_state = function() {
    ...
    const match = saved_route == null ? void 0 : saved_route.match(/^\/app\/([^/?#]+)$/);
  ...
  retail_shop.get_workspace_context = function() {
    ...
    const route_slug = workspace_name ? (_a2 = frappe.router) == null ? void 0 : _a2.slug(workspace_name) : "";
    const visible_slugs = retail_shop.get_visible_workspaces().map(
      (workspace) => {
        var _a3;
        return (_a3 = frappe.router) == null ? void 0 : _a3.slug(workspace);
      }
    );
    const home_slug = (_b2 = frappe.router) == null ? void 0 : _b2.slug(retail_shop.home_workspace);
  ...
  retail_shop.looks_like_retail_workspace = function() {
    const titles = Array.from(document.querySelectorAll(".layout-main-section .widget-title")).map((node) => {
      var _a2;
  ...
  retail_shop.is_retail_workspace_surface = function() {
    ...
    return context.is_home_route || retail_shop.is_retail_shop_path() || retail_shop.looks_like_retail_workspace();
  };
  ...
  retail_shop.patch_home_route = function() {
    ...
    const home_slug = (_a2 = frappe.router) == null ? void 0 : _a2.slug(retail_shop.home_workspace);
    if (!home_slug) {
      return;
    }
  ...
  retail_shop.get_native_card_title = function(widget) {
    var _a2, _b2, _c, _d;
    return ((_b2 = (_a2 = widget.querySelector(".widget-title .ellipsis")) == null ? void 0 : _a2.textContent) == null ? void 0 : _b2.trim()) || ((_d = (_c = widget.querySelector(".widget-title")) == null ? void 0 : _c.textContent) == null ? void 0 : _d.trim()) || "";
  };
  retail_shop.decorate_card_header = function(widget, head, meta) {
    var _a2;
    (_a2 = head.querySelector(".retail-shop-card-kicker-row")) == null ? void 0 : _a2.remove();
  ...
  retail_shop.decorate_link_tile = function(link, meta, is_primary) {
    ...
    if (meta == null ? void 0 : meta.description) {
      ...
      description == null ? void 0 : description.remove();
    }
  };
  ...
  retail_shop.build_tabbed_workspace = function() {
    ...
    const card_blocks = Array.from(redactor.querySelectorAll(".ce-block")).filter(
      (block) => block.querySelector(".widget.links-widget-box.retail-shop-card[data-retail-section]")
    );
    ...
    retail_shop.set_active_workspace_tab(
      shell,
      active_section && panels.querySelector(`.retail-shop-tab-panel[data-section="${active_section}"]`) ? active_section : card_blocks[0].dataset.section || ((_a2 = card_blocks[0].querySelector(".widget.links-widget-box")) == null ? void 0 : _a2.dataset.retailSection)
    );
  };
  retail_shop.decorate_native_workspace_cards = function(is_retail_home) {
    ...
    widgets.forEach((widget) => {
      ...
      body == null ? void 0 : body.classList.remove("retail-shop-card-body");
      widget.querySelectorAll(".link-item").forEach((link) => {
        link.classList.remove("retail-shop-link-tile", "retail-shop-link-tile--primary");
      });
      (_a2 = widget.querySelector(".retail-shop-card-description")) == null ? void 0 : _a2.remove();
      (_b2 = widget.querySelector(".retail-shop-card-kicker-row")) == null ? void 0 : _b2.remove();
      ...
      body == null ? void 0 : body.classList.add("retail-shop-card-body");
      if (head) {
      ...
      widget.querySelectorAll(".link-item").forEach((link) => {
        var _a3, _b3;
        const label = ((_b3 = (_a3 = link.querySelector(".link-text")) == null ? void 0 : _a3.textContent) == null ? void 0 : _b3.trim()) || "";
  ...
  retail_shop.patch_boot_workspaces = function() {
    var _a2;
    if (retail_shop.boot_workspaces_patched || !retail_shop.should_filter_home_workspace()) {
      return;
    }
    if (!Array.isArray((_a2 = frappe.boot) == null ? void 0 : _a2.allowed_workspaces)) {
  ...
  retail_shop.patch_workspace_sidebar = function() {
    var _a2;
    if (retail_shop.workspace_sidebar_patched || !retail_shop.should_filter_home_workspace() || !((_a2 = frappe.views) == null ? void 0 : _a2.Workspace)) {
      return;
    }
  ...
  retail_shop.patch_workspace_show_page = function() {
    var _a2;
    if (retail_shop.workspace_show_page_patched || !retail_shop.should_filter_home_workspace() || !((_a2 = frappe.views) == null ? void 0 : _a2.Workspace)) {
      return;
    }
  ...
  retail_shop.decorate_retail_workspace = function() {
    ...
    (_a2 = retail_shop.workspace_widget_observer) == null ? void 0 : _a2.disconnect();
    try {
      const is_retail_home = document.body.classList.contains("retail-shop-home-active") || retail_shop.is_retail_workspace_surface();
      ...
      document.querySelectorAll(".layout-main-section .widget.shortcut-widget-box").forEach((widget) => {
        var _a3, _b3;
        const title = ((_b3 = (_a3 = widget.querySelector(".widget-title")) == null ? void 0 : _a3.textContent) == null ? void 0 : _b3.trim()) || "";
        const card = widget.closest(".retail-shop-section-card");
        const is_primary_shortcut = (card == null ? void 0 : card.dataset.section) === "sales-counter" && retail_shop.primary_shortcuts.has(title);
      ...
      (_b2 = retail_shop.workspace_widget_observer) == null ? void 0 : _b2.observe(document.body, {
        childList: true,
        subtree: true
      });
    }
  ...
  retail_shop.wrap_workspace_sections = function() {
    ...
    Array.from(redactor.children).forEach((block) => {
      ...
      if (header) {
        const title = ((_a2 = header.textContent) == null ? void 0 : _a2.trim()) || "";
        const meta = retail_shop.section_meta[title];
        const section_slug = (meta == null ? void 0 : meta.slug) || frappe.router.slug(title || "section");
  ...
  retail_shop.init_workspace_customizations = function() {
    ...
    (_a2 = frappe.after_ajax) == null ? void 0 : _a2.call(frappe, () => retail_shop.sync_workspace_page_state());
  };
  ...
  var _a, _b;
  (_b = (_a = frappe.router) == null ? void 0 : _a.on) == null ? void 0 : _b.call(_a, "change", retail_shop.sync_workspace_page_state);
...
//# sourceMappingURL=retail_shop.bundle.AOAH4C5V.js.map
